...
class DirectMessageIndexRequest(Request):
    ...
    def __init__(self, gmi: GMI, other_user_id: str, before_id: str=..., since_id: str=...): ...
    def url(self) -> str: ...
    def args(self) -> dict: ...
...
class DirectMessageCreateRequest(Request):
    ...
    def __init__(self, gmi: GMI, sender_id: str, recipient_id: str, text: str, attachments: dict=...): ...
